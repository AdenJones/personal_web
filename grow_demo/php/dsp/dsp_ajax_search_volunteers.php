	<table class="general" style="width:100%;">
		<tr><th>Search Volunteers <img onclick="jsHidePopUp(window.mem_sel_popup_container)" class="float_right generic_close" src="/grow_demo_html/images/white_close.gif"/></th></tr>
