            	...
            	<div class="generic_form">
                    ...
                    <div class="form_row">
                    	<form action="<?php echo "$full_uri/index.php"; ?>" method="post" onsubmit="document.getElementById('group_by_group_Loading').style.display = 'block';">
                        	<input type="hidden" name="page_id" value="report_attendances" /> <!-- Post to self for validation -->
                            <input type="hidden" name="form_submitted" value="1" />
                            <div class="form_row">
                            	<?php cntGroupRegionBranchSelector('attendees_report',$ReportRanges,$TypeSelected,$Group,$GroupID,$Regions,$RegionID,$arr_branches,$Branch) ?>
                            </div>
