			<div class="generic_form">
            	<div class="form_major_heading"><h1><?php echo $page_name ?></h1></div>
           		<form action="<?php echo "$full_uri/index.php"; ?>" method="post">
                	...
                	<input type="hidden" name="page_id" value="add_edit_community_outreach" />
                	...
                	<div class="form_row">
                    	<div class="form_heading"><h2>Event Details</h2></div>
						<?php cntText('Event Name:','TeamName',$TeamName,'Team Name'); ?>
                    </div>
                    <div class="form_row">
                    	<div class="form_heading"><h2>Event Dates</h2></div>
