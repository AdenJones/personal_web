        ...
        <div id="body">
            ...
            <div id="content">
            	<div class="generic_form">
                    ...
                    <div class="form_row">
                    	<form action="<?php echo "$full_uri/index.php"; ?>" method="post" onsubmit="document.getElementById('group_by_branch_Loading').style.display = 'block';">
                        	<input type="hidden" name="page_id" value="report_group_by_branch_improved" /> <!-- Post to self for validation -->
					...
					<?php cntLoading('group_by_branch'); ?>
