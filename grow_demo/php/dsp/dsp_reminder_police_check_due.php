           		...
           		<div class="generic_form">
					...
					<div class="form_row">
						...
						if( $_SESSION['User']->GetUserTypeName() != $StateUser )
						{
							...
							if(count($VolDuePoliceChecks) == 0 )
							{
								echo '<div class="form_item_major_block">';
									echo '<div class="form_row">';
									echo '<div class="form_heading"><h2>No Volunteer Police Checks due at this time!</h2></div>';
									echo '</div>';
								echo '</div>';
								...
								echo '<div class="form_item_major_block">';
								echo '<div class="form_row">';
								echo '<div class="form_heading"><h2>'.count($VolDuePoliceChecks).' Volunteer Police Checks due at this time!</h2></div>';
