	<table class="general" style="width:100%;">
		<tr><th>Search Groups <img onclick="jsHidePopUp(window.grp_sel_popup_container)" class="float_right generic_close" src="<?php echo BaseExternalURL; ?>/images/white_close.gif"/></th></tr>
