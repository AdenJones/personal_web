		...
		if( $blnIsGood )
		{
			...
			if($TypeSelected == GROUP and $HasGroup)
			{
				...
				//include '../php/async/async_statistics_by_group.php';
				 ...
				 $cmd = "php ../php/async/async_statistics_by_group.php ".$GroupID." ".$StartDate." ".$EndDate." ".$ReportID." ".$_SESSION['User']->GetUserID();
			...
			elseif($TypeSelected == REGION and $HasRegion)
			{
				...
				$cmd = "php ../php/async/async_statistics_by_region.php ".$RegionID." ".$StartDate." ".$EndDate." ".$ReportID." ".$_SESSION['User']->GetUserID();
			...
			elseif($TypeSelected == BRANCH and $HasBranch)
			{
				...
				$cmd = "php ../php/async/async_statistics_by_branch.php ".$Branch." ".$StartDate." ".$EndDate." ".$ReportID." ".$_SESSION['User']->GetUserID();
