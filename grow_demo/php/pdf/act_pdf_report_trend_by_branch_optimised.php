<?php
	...
	if($intSubmitted == 1)
	{
		...
		if( $blnIsGood )
		{
			...
			$TrendStats = $BranchObject->LoadTrendStats($str_safe_s_date,$str_safe_e_date);
			
			//$CGAChecker = $BranchObject->TotalCommittedGrowersAttInPeriodByMonthDates($str_safe_s_date,$str_safe_e_date);
